        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-amber-500/30 transition-colors duration-300 shadow-lg hover:shadow-amber-500/5">
          ...
          <div className="space-y-3">
            <div className="flex items-start">
              <svg className="w-5 h-5 text-amber-500 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-white">{user?.city}, {user?.state}</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg className="w-5 h-5 text-amber-500 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                ...
                <p className="text-white">{user?.country} ({user?.zip_code})</p>
              </div>
            </div>
          </div>
        </div>
